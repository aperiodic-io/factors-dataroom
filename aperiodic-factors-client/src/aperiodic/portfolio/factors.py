...
def get_portfolio_factors_historical(
    ...
    """
    Fetch historical factors for a portfolio from the Aperiodic Factors API.
    ...
    Args:
        ...
        smoothing (str | None): Portfolio smoothing window for the data. Valid values and default smoothing for each portfolio can be found in the [Aperiodic Factors Catalog](https://factors.aperiodic.io/home/api/catalog)
