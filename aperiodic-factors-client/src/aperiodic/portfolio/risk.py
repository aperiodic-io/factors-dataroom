...
def get_risk_overlay(
    ...
    Args:
        portfolio: Portfolio ID (see [Aperiodic Factors Catalog](https://factors.aperiodic.io/home/api/catalog/portfolios))
        overlay: Risk overlay ID (see [Aperiodic Factors Catalog](https://factors.aperiodic.io/home/api/catalog/risk-overlays))
