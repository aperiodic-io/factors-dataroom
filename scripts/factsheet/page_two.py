...
def _draw_header(fig: plt.Figure, factor: Factor, page: int) -> None:
    """Header — mirrors page 1: logo + Aperiodic Factors wordmark left, page label right."""
...
_NOTICE = (
    ...
    "the property of Aperiodic Factors and its affiliates (“Aperiodic Factors”) or its "
    "licensors. Aperiodic Factors does not provide investment advice and nothing in "
    ...
    "suggest or reflect an opinion of Aperiodic Factors. Financial instruments based "
    "on Aperiodic Factors’ factors or indices are in no way sponsored, endorsed, sold "
    "or promoted by Aperiodic Factors. The Content is provided solely for "
    ...
    "by any means without the prior written consent of Aperiodic Factors. THE CONTENT "
    "IS PROVIDED ON AN “AS IS” BASIS AND APERIODIC FACTORS DISCLAIMS ANY AND ALL "
    ...
    "BUGS, OR SOFTWARE ERRORS OR DEFECTS. In no event shall Aperiodic Factors be "
...
def _draw_about_and_notice(fig: plt.Figure, factor: Factor) -> None:
    """ABOUT APERIODIC FACTORS section (heading + rule + body + further-materials
    ...
    # --- About Aperiodic Factors — proper section stacked above the notice ---
    btn_gap = 0.02
    ...
    _section_rule(fig, about_head_y, "ABOUT APERIODIC FACTORS")
    fig.text(
        MARGIN_X,
        about_body_top,
