# %% [markdown]
# # Adding Open Interest Divergence to an existing portfolio
#
# This notebook measures what a **Open Interest Divergence** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['open_interest_divergence.40']
FACTOR_LABEL = "Open Interest Divergence"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Open Interest Divergence** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/open_interest_divergence](https://factors.aperiodic.io/catalog/open_interest_divergence)
