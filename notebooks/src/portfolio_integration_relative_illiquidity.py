# %% [markdown]
# # Adding Relative Illiquidity to an existing portfolio
#
# This notebook measures what a **Relative Illiquidity** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['relative_illiquidity.40']
FACTOR_LABEL = "Relative Illiquidity"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Relative Illiquidity** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/relative_illiquidity](https://factors.aperiodic.io/catalog/relative_illiquidity)
