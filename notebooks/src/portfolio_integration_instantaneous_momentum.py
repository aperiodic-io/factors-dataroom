# %% [markdown]
# # Adding Instantaneous Momentum to an existing portfolio
#
# This notebook measures what a **Instantaneous Momentum** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['instantaneous_momentum.40']
FACTOR_LABEL = "Instantaneous Momentum"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Instantaneous Momentum** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/instantaneous_momentum](https://factors.aperiodic.io/catalog/instantaneous_momentum)
