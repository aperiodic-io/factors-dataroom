# %% [markdown]
# # Adding Enhanced Carry to an existing portfolio
#
# This notebook measures what a **Enhanced Carry** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['carry_enhanced.40']
FACTOR_LABEL = "Enhanced Carry"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Enhanced Carry** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/carry_enhanced](https://factors.aperiodic.io/catalog/carry_enhanced)
