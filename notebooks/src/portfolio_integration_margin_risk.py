# %% [markdown]
# # Adding Margin Risk to an existing portfolio
#
# This notebook measures what a **Margin Risk** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['margin_risk.40']
FACTOR_LABEL = "Margin Risk"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Margin Risk** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/margin_risk](https://factors.aperiodic.io/catalog/margin_risk)
