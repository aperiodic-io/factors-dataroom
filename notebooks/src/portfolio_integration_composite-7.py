# %% [markdown]
# # Adding 7 Factor Composite to an existing portfolio
#
# This notebook measures what a **7 Factor Composite** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['momentum_enhanced.40', 'carry_enhanced.40', 'retail_flow.40', 'margin_risk.40', 'altair.40', 'mean_reversion.40', 'mean_reversion_enhanced.40']
FACTOR_LABEL = "7 Factor Composite"
...
# ### The factor sleeve
#
# **7 Factor Composite** is reconstructed client-side as the equal-weight average of its 7 constituents' published portfolio returns -- the single-portfolio endpoint does not serve the composite directly.
...
#   [factors.aperiodic.io/catalog/composite-7](https://factors.aperiodic.io/catalog/composite-7)
