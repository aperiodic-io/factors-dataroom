# %% [markdown]
# # Adding Mean Reversion to an existing portfolio
#
# This notebook measures what a **Mean Reversion** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['mean_reversion.40']
FACTOR_LABEL = "Mean Reversion"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Mean Reversion** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/mean_reversion](https://factors.aperiodic.io/catalog/mean_reversion)
