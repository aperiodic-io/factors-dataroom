...
from aperiodic import get_prices, get_price
...
portfolio_historical_weights = get_portfolio_historical_weights(
    ...
    smoothing=None,  # This will use the default smoothing please see catalog for default values for each portfolio (https://factors.aperiodic.io/home/api/catalog/portfolios)
