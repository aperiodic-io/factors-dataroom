# %% [markdown]
# # Adding Instantaneous Volatility to an existing portfolio
#
# This notebook measures what a **Instantaneous Volatility** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['instantaneous_volatility.40']
FACTOR_LABEL = "Instantaneous Volatility"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Instantaneous Volatility** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/instantaneous_volatility](https://factors.aperiodic.io/catalog/instantaneous_volatility)
