# %% [markdown]
# # Adding Altair to an existing portfolio
#
# This notebook measures what a **Altair** sleeve does to a book you already
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Altair** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/altair](https://factors.aperiodic.io/catalog/altair)
