# %% [markdown]
# # Adding Polaris to an existing portfolio
#
# This notebook measures what a **Polaris** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['polaris.40']
FACTOR_LABEL = "Polaris"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Polaris** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/polaris](https://factors.aperiodic.io/catalog/polaris)
