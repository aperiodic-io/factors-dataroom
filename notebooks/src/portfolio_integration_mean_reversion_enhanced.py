# %% [markdown]
# # Adding Enhanced Mean Reversion to an existing portfolio
#
# This notebook measures what a **Enhanced Mean Reversion** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['mean_reversion_enhanced.40']
FACTOR_LABEL = "Enhanced Mean Reversion"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Enhanced Mean Reversion** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/mean_reversion_enhanced](https://factors.aperiodic.io/catalog/mean_reversion_enhanced)
