# %% [markdown]
# # Adding Supply Velocity to an existing portfolio
#
# This notebook measures what a **Supply Velocity** sleeve does to a book you already
...
FACTOR_PORTFOLIOS = ['supply_velocity.40']
FACTOR_LABEL = "Supply Velocity"
...
# ### The factor sleeve
#
# The sleeve is the published, unlevered (1x) daily returns of the **Supply Velocity** top-40 portfolio.
...
#   [factors.aperiodic.io/catalog/supply_velocity](https://factors.aperiodic.io/catalog/supply_velocity)
